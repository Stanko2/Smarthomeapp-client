        ...
        builder: (context, child) {
          ...
          return Padding(
            ...
            child: Container(
              ...
              width: cellWidth,
              height: cellHeight + (widget.innerHeight * _animationController.value),
              child: Stack(
                children: <Widget>[
                  ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: widget.innerWidget != null
                          ? OverflowBox(
                              ...
                              maxHeight: cellHeight + widget.innerHeight,
                  ...
                  Transform(
                    ...
                    child: Transform(
                      ...
                      child: Transform.translate(
                        offset: _isExpanded ? Offset(0, cellHeight) : Offset(0,0),
                        child: ClipRRect(
                          borderRadius: BorderRadius.only(
